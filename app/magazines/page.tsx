...
/**
 * Page EVENTS (informatif)
 * - Même style que ta page magazine
 * - Données en dur (events[]) -> facile à brancher ensuite à une DB/CMS
 */
  ...
  return (
    <section className="relative min-h-screen px-6 pt-32 pb-24">
      <motion.h1
        ...
        className="text-[14vw] leading-[0.9] font-extrabold tracking-tight"
      >
        EVENTS
        <br />
        &<br />
      ...
      <p className="absolute right-6 bottom-24 max-w-xs text-sm uppercase tracking-widest text-gray-500">
        Événements / informations — Paris & Online
      </p>

      <div className="mt-16 grid gap-6 md:grid-cols-12">
        <div className="md:col-span-5">
          <p className="text-lg text-gray-700">
            Une page simple pour suivre nos dates : rencontres, workshops,
            conférences, projections. Tout est ici, mis à jour régulièrement.
          </p>
      ...
      <div className="pointer-events-none absolute -left-10 top-24 text-[18vw] font-black text-gray-100 select-none">
        01
      </div>
    </section>
  );
...
function IntroEvents() {
  return (
    <section className="px-6 py-24 border-t border-black/10">
      <div className="mx-auto max-w-6xl grid gap-12 md:grid-cols-12 items-start">
        ...
        <div className="md:col-span-8">
          ...
          <div className="mt-10 grid gap-8 md:grid-cols-2 text-gray-700">
            <p>
              Formats : meetups, workshops, talks, backstage, projections. Le but
              : apprendre, rencontrer, et faire circuler les bonnes pratiques.
            </p>
            <p>
              Certains événements sont gratuits, d’autres sur inscription. Les
              détails (dates, lieu, horaires) sont indiqués sur chaque carte.
            </p>
          </div>
        </div>
      </div>
...
function EventsGrid() {
  return (
    <section id="agenda" className="px-6 py-24 border-t border-black/10">
      ...
      <div className="mx-auto mt-14 max-w-6xl grid gap-5 md:grid-cols-12 md:auto-rows-[180px]">
        {events.map((ev, idx) => (
...
function EventCard({
  ...
  return (
    <motion.article
      ...
      className={`group relative overflow-hidden rounded-3xl ${size}`}
    >
      ...
      <div className="absolute left-6 right-6 bottom-6">
        ...
        <h3 className="mt-2 text-white text-2xl font-semibold leading-tight">
          {title}
        </h3>
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-14 grid gap-10 md:grid-cols-12 items-start">
          ...
          <div className="md:col-span-9 grid gap-8 md:grid-cols-2 text-gray-700">
            <p>
              Les horaires, adresses et modalités (gratuit / inscription) peuvent
              évoluer : cette page fait foi.
            </p>
            <p>
              Pour proposer un partenariat, une salle, ou une intervention : écris-nous
              via la section infos.
            </p>
          </div>
        </div>
      </div>
...
function EventsFooter() {
  return (
    <section id="infos" className="px-6 py-24 border-t border-black/10">
      <div className="mx-auto max-w-6xl grid gap-12 md:grid-cols-12 items-end">
        <div className="md:col-span-7">
          ...
          <p className="mt-6 max-w-xl text-gray-700 text-lg">
            Tu veux recevoir les prochaines dates ? On peut te partager les infos
        ...
        <div className="md:col-span-5 md:justify-self-end">
          <div className="rounded-3xl border border-black/10 p-8">
            <p className="text-sm text-gray-600">
              Paris / Online — mises à jour régulières
            </p>
            ...
            <div className="mt-6 text-xs text-gray-500 leading-relaxed">
              Tu peux aussi ajouter un lien “Newsletter” ou “WhatsApp” ici si tu as
              une liste.
            </div>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-6xl mt-16 flex items-center justify-between text-xs text-gray-500">
